...
public class PlaceCollectPlaceCollect extends AutonomousBase {
    ...
    private static final Pose2d SECOND_PLACE_PT_2 = new Pose2d(Units.inchesToMeters(69.6), Units.inchesToMeters(196.325 - 10.0),
    ...
    private static final Pose2d FIRST_COLLECT_PT_2 = new Pose2d(Units.inchesToMeters(69.6 + 195.9), Units.inchesToMeters(196.325 - 5),
            new Rotation2d(Units.degreesToRadians(180)));
    private static final Pose2d SECOND_COLLECT = new Pose2d(Units.inchesToMeters(69.6 + 195.9), Units.inchesToMeters(196.325 - 30),
            new Rotation2d(Units.degreesToRadians(-35)));
    ...
    private static final Translation2d MID_PT_3 = new Translation2d(Units.inchesToMeters(69.6 + 100.0), Units.inchesToMeters(196.325 + 15));
    ...
    public PlaceCollectPlaceCollect(DriverStation.Alliance alliance) {
        ...
        Trajectory secondCollectTrajectory = createTrajectory(SECOND_PLACE_PT_2, List.of(MID_PT_3), SECOND_COLLECT, CONFIG);
