...
public class LoadingNoTurn3 extends AutonomousBase {
    ...
    public LoadingNoTurn3(DriverStation.Alliance alliance) {
        ...
        final FudgeableTranslation SECOND_GOING_AROUND = FudgeableTranslation.newWithInches(274, 177);
        final FudgeableTranslation SECOND_GOING_COLLECT = FudgeableTranslation.newWithInches(269, 130);
        ...
        Trajectory collectTrajectory3 = createTrajectory(SECOND_PLACE_MIRRORED, List.of(FIRST_GOING_OUT), GOING_OUT, CONFIG_GOING);
