...
public class LoadingTwoPiece extends AutonomousBase {
    public LoadingTwoPiece(DriverStation.Alliance alliance) {
        final Pose2d FIRST_PLACE = new Pose2d(Units.inchesToMeters(69.6), Units.inchesToMeters(196.325),
                new Rotation2d(0));
        final Pose2d SECOND_PLACE = new Pose2d(Units.inchesToMeters(69.6), Units.inchesToMeters(196.325 - 24.0),
        ...
        final Pose2d FIRST_COLLECT = new Pose2d(Units.inchesToMeters(69.6 + 200.9), Units.inchesToMeters(196.325 - 5),
                new Rotation2d(Units.degreesToRadians(-35)));
        final Pose2d FIRST_COLLECT_2 = new Pose2d(Units.inchesToMeters(69.6 + 200.9), Units.inchesToMeters(196.325 - 5),
                new Rotation2d(Units.degreesToRadians(180)));
        ...
        final TrajectoryConfig CONFIG = new TrajectoryConfig(2.0, 3)
