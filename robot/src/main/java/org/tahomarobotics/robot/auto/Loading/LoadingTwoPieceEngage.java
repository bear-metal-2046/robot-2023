...
public class LoadingTwoPieceEngage extends AutonomousBase {
    public LoadingTwoPieceEngage(DriverStation.Alliance alliance) {
        ...
        final Pose2d ENGAGE = new Pose2d(Units.inchesToMeters(69.6 + 85.0), Units.inchesToMeters(125.0),
        ...
        final Translation2d MID_PT_3 = new Translation2d(Units.inchesToMeters(69.6 + 12.0), Units.inchesToMeters(125.0));
