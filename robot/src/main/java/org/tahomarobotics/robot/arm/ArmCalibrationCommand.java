...
public class ArmCalibrationCommand extends CommandBase {
    ...
    public void initialize() {
        ...
        arm.calibration(ArmSubsystemIF.CalibrationAction.Initiate);
    }
    ...
    public void end(boolean interrupted) {
        if (interrupted) {
            arm.calibration(ArmSubsystemIF.CalibrationAction.Cancel);
        } else {
            arm.calibration(ArmSubsystemIF.CalibrationAction.Finalize);
        }
    }
